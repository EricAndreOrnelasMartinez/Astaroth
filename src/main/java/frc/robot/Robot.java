...
public class Robot extends TimedRobot {
  ...
  public static ArmUpDwon m_ArmUpDwon;
  public static Chassis m_Chassis;
  public static ForwardBackward m_ForwardBackward;
  public static Wipper m_Wipper;
  ...
  public void robotInit() {
    ...
    m_ForwardBackward = new ForwardBackward();
    m_Wipper = new Wipper();
    m_drive = new Drive(m_Chassis);
    m_robotContainer = new RobotContainer();
    m_autonomousCommand = new Autonomus(m_ArmUpDwon, m_ForwardBackward, m_Chassis, m_Wipper);
  }
